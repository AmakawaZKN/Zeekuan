...
capuser[m.sender.split('@')[0]] = { user: sender, jawaban: jawaban.toLowerCase()}  
  fs.writeFileSync("./worker/src/captcha/capuser.json", JSON.stringify(capuser))
        ...
        sock.sendMessage(
         ...
         footer: '𝕵𝖎𝖎𝖐𝖚𝖆𝖓 | 𝙕𝙮𝙠𝙪𝙖𝙣', mentions: [sender] 
         })
...
"title": "𝕵𝖎𝖎𝖐𝖚𝖆𝖓 | 𝙕𝙮𝙠𝙪𝙖𝙣", //Kasih namalu 
...
status: 1,
surface : 1,
message: '𝕵𝖎𝖎𝖐𝖚𝖆𝖓 | 𝙕𝙮𝙠𝙪𝙖𝙣', //Kasih namalu
orderTitle: 'Bang',
...
"title": `ALL MENU`,
"description": `${listmn}`,
"footerText": `©𝕵𝖎𝖎𝖐𝖚𝖆𝖓 | 𝙕𝙮𝙠𝙪𝙖𝙣`,
"currencyCode": "IDR",
"priceAmount1000": "100000000000000000",
"productImageCount": 1,
"firstImageId": 1,
"salePriceAmount1000": "1000",
"retailerId": `© 𝕵𝖎𝖎𝖐𝖚𝖆𝖓 | 𝙕𝙮𝙠𝙪𝙖𝙣`,
"url": `hdhhd`
},
...
url: 'https://github.com/AmakawaZKN/'
}
}, {
urlButton: {
displayText: 'Group Whatsapp',
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(i, txt, "© 𝕵𝖎𝖎𝖐𝖚𝖆𝖓 | 𝙕𝙮𝙠𝙪𝙖𝙣", log0, btn, thum)
}
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(yoi, txt, "© 𝕵𝖎𝖎𝖐𝖚𝖆𝖓 | 𝙕𝙮𝙠𝙪𝙖𝙣", log0, btn, thum)
}
...
title:"𝙕𝙮𝙠𝙪𝙖𝙣 ~ MD Qris ( Donate )",
body: "©𝙕𝙮𝙠𝙪𝙖𝙣", 
thumbnail: fs.readFileSync("worker/media/image/Deff.jpg"),
mediaType:1,
mediaUrl: 'https://telegra.ph/file/b5e5439b8349bdd9dd11e.jpg',
sourceUrl: "https://telegra.ph/file/b5e5439b8349bdd9dd11e.jpg"
}}
}
sock.sendMessage(m.chat, buttonMessage, { quoted: m })
}
...
case prefix+'nulis': {
if (isBan) return ads(mess.ban)
if (args.length < 1) return ads(`Example :\n${prefix}nulis 𝙕𝙮𝙠𝙪𝙖𝙣|91|#ff020a|Manusia terganteng adalah 𝙕𝙮𝙠𝙪𝙖𝙣`)
const nls = args.join(" ")
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"𝕵𝖎𝖎𝖐𝖚𝖆𝖓 | 𝙕𝙮𝙠𝙪𝙖𝙣 ~ Twitter Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"𝕵𝖎𝖎𝖐𝖚𝖆𝖓 | 𝙕𝙮𝙠𝙪𝙖𝙣 ~ Facebook Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"𝕵𝖎𝖎𝖐𝖚𝖆𝖓 | 𝙕𝙮𝙠𝙪𝙖𝙣 ~ Tiktok Downloader",
body:res.title,
thumbnail: log0,
mediaType:1,
mediaUrl: args[0],
